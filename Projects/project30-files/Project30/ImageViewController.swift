...
class ImageViewController: UIViewController {
    ...
    override func viewDidLoad() {
		...
		title = urlString.replacingOccurrences(of: "-Large.jpg", with: "")
        guard let original = UIImage(contentsOfFile: self.urlString) else { return }
	...
	override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
		...
		var currentVal = defaults.integer(forKey: urlString)
		currentVal += 1

		defaults.set(currentVal, forKey: urlString)
