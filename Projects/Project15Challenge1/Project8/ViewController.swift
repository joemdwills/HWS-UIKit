...
//  Project8
//
//  Created by Joe Williams on 28/09/2021.
//
...
//        buttonsView.backgroundColor = .lightGray
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            score += 1
            solutionsFound += 1
            print("Answers found: \(solutionsFound)")
            ...
            let ac = UIAlertController(title: "Incorrect", message: "That guess isn't one of the answers, try again!", preferredStyle: .alert)
            ac.addAction(UIAlertAction(title: "Try again", style: .default, handler: clear))
            present(ac, animated: true)
